...
UIKIT_EXTERN NSString *const FXFormNotificationFieldChanged; //notification
...
UIKIT_EXTERN NSString *const FXFormFieldDetailTitle; //detail
...
UIKIT_EXTERN NSString *const FXFormFieldEditable; //userInteractionEnabled
